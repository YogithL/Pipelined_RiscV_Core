...
REM
REM Generated by Vivado on Mon Jun 08 19:38:58 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj SimpleTestBench_vlog.prj"
call xvlog  --incr --relax -L uvm -prj SimpleTestBench_vlog.prj -log xvlog.log
