...
class data_hazard_d3_seq extends uvm_sequence#(base_stim_packet);
    `uvm_object_utils(data_hazard_d3_seq)

    function new(string name = "data_hazard_d3_seq");
        super.new(name);
    endfunction
    ...
    virtual task body();
        ...
        base_stim_packet filler2 = base_stim_packet::type_id::create("filler2");
